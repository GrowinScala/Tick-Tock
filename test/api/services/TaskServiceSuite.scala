...
class TaskServiceSuite extends AsyncWordSpec with MustMatchers with MockitoSugar {
  ...
  "TaskService#scheduleTask" should {
    ...
    "receive a Personalized TaskDTO and store a new entry in the cancellableMap." in {
      taskService.actorMap.isEmpty mustBe true
      val taskDTO = TaskDTO("asd", "asd", SchedulingType.Personalized, Some(stringToDateFormat("2030-01-01 12:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, Some(stringToDateFormat("2040-01-01 12:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, None, None, Some(List(SchedulingDTO("asd1", "asd", Some(stringToLocalDateFormat("2035-01-01", "yyyy-MM-dd"))))))
      taskService.scheduleTask(taskDTO)
      taskService.actorMap.size mustBe 1
      taskService.actorMap.head._1 mustBe "asd"
      taskService.actorMap -= "asd"
  ...
  "TaskService#calculateExclusions" should {
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with exclusionDate and no startDate)" in {
      val dto = TaskDTO("asd", "asd", SchedulingType.Periodic, Some(stringToDateFormat("2030-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), Some(PeriodType.Minutely), Some(5), Some(stringToDateFormat("2040-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, None, Some(List(ExclusionDTO("asd", "asd", Some(stringToLocalDateFormat("2035-01-01", "yyyy-MM-dd"))))))
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2035-01-01", "yyyy-MM-dd"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with exclusionDate and startDate)" in {
      val dto = TaskDTO("asd", "asd", SchedulingType.Periodic, None, Some(PeriodType.Minutely), Some(5), Some(stringToDateFormat("2040-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, None, Some(List(ExclusionDTO("asd", "asd", Some(stringToLocalDateFormat("2035-01-01", "yyyy-MM-dd"))))))
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2035-01-01", "yyyy-MM-dd"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with exclusionDate and timezone)" in {
      val dto = TaskDTO("asd", "asd", SchedulingType.Periodic, Some(stringToDateFormat("2030-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), Some(PeriodType.Minutely), Some(5), Some(stringToDateFormat("2040-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, Some("PST"), Some(List(ExclusionDTO("asd", "asd", Some(stringToLocalDateFormat("2035-01-01", "yyyy-MM-dd"))))))
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2035-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day) (with endDate)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-15 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day) (Periodic minutely with occurrences)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day) (Periodic hourly with occurrences)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-02 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day) (Periodic daily with occurrences)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-04 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day) (Periodic weekly with occurrences)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-15 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day) (Periodic monthly with occurrences)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-10 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-10 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-03-10 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day) (Periodic yearly with occurrences)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-06-20 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayType)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-05 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-06 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with month)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-31 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-12-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-31 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day and dayOfWeek)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-05 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day and month)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-06-10 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2031-06-10 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day and year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-10-10 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-11-10 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-10 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek and dayType)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-08 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-22 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-29 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek and month)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-04 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-11 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-18 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-25 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek and year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-12-16 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-23 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-30 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayType and month)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-02-02 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-03 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-09 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-10 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-16 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-17 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-23 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-24 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayType and year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-12-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-21 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-22 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-28 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-29 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with month and year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-12-25 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-26 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-27 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-28 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-29 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-31 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, dayType)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-05-20 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, month)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-07-19 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-16 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-10-16 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayType, month)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-04-11 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2031-04-11 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    } //new
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, month, year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2031-11-29 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    } //new
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek, dayType, month)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-08-04 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-08-11 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-08-18 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-08-25 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek, dayType, year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-12-07 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-14 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-21 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-28 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayType, month, year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-11-16 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-11-17 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-11-23 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-11-24 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-11-30 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, dayType, month)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-09-10 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, dayType, year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-04-05 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-07-05 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, month, year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-05-01 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayType, month, year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-11-30 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek, dayType, month, year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-10-07 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-10-14 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-10-21 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-10-28 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, dayType, month, year)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-03-01 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-02-12 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-16 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with month and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-06-30 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-03-13 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayType and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-09-07 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, month and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2033-08-28 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-12-23 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek, dayType and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-07 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek, month and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-09-14 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-21 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayType, month and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-04-14 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayType, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-12-31 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, dayType and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-03-17 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, month and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2047-08-16 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-12-12 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayType, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-02-05 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, month, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-08-19 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek, dayType, month and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-10-26 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayType, month, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-04-07 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, dayType, month and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-11-26 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, dayType, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-10-20 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayOfWeek, month, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-03-11 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with day, dayType, month, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-09-09 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with an exclusion and return a Queue with the corresponding Date(s) for that exclusion. (with dayOfWeek, dayType, month, year and criteria)" in {
      ...
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-06 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with several exclusions and return a Queue with the corresponding Dates for those exclusions. #1" in {
      val dto = TaskDTO("asd", "asd", SchedulingType.Periodic, Some(stringToDateFormat("2030-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), Some(PeriodType.Minutely), Some(5), Some(stringToDateFormat("2030-07-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, None, Some(List(ExclusionDTO("asd1", "asd", None, Some(15)), ExclusionDTO("asd2", "asd", None, None, None, Some(DayType.Weekend), None, None, Some(Criteria.First)))))
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-05 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-03-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-04-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-05-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-06-15 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }

    "receive a valid TaskDTO with several exclusions and return a Queue with the corresponding Dates for those exclusions. #2" in {
      val dto = TaskDTO("asd", "asd", SchedulingType.Periodic, Some(stringToDateFormat("2030-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), Some(PeriodType.Minutely), Some(5), Some(stringToDateFormat("2032-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, None, Some(List(ExclusionDTO("asd1", "asd", None, Some(30), None, Some(DayType.Weekday), None, Some(2030)), ExclusionDTO("asd2", "asd", Some(stringToLocalDateFormat("2031-05-02", "yyyy-MM-dd"))), ExclusionDTO("asd3", "asd", None, None, Some(6), None, None, Some(2030), Some(Criteria.First)))))
      taskService.calculateExclusions(dto) mustBe List(stringToLocalDateFormat("2030-01-04 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-04-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-05-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-07-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-08-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-09-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-10-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2031-05-02 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
  ...
  "TaskService#calculateSchedulings" should {
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with schedulingDate and no startTime)" in {
      val dto = TaskDTO("asd", "asd", SchedulingType.Personalized, None, Some(PeriodType.Minutely), Some(5), Some(stringToDateFormat("2040-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, None, None, Some(List(SchedulingDTO("asd", "asd", Some(stringToLocalDateFormat("2035-01-01", "yyyy-MM-dd"))))))
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2035-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with schedulingDate and startTime)" in {
      val dto = TaskDTO("asd", "asd", SchedulingType.Personalized, Some(stringToDateFormat("2030-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), Some(PeriodType.Minutely), Some(5), Some(stringToDateFormat("2040-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, None, None, Some(List(SchedulingDTO("asd", "asd", Some(stringToLocalDateFormat("2035-01-01", "yyyy-MM-dd"))))))
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2035-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with schedulingDate and timezone)" in {
      val dto = TaskDTO("asd", "asd", SchedulingType.Personalized, Some(stringToDateFormat("2030-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), Some(PeriodType.Minutely), Some(5), Some(stringToDateFormat("2040-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, Some("PST"), None, Some(List(SchedulingDTO("asd", "asd", Some(stringToLocalDateFormat("2035-01-01", "yyyy-MM-dd"))))))
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2035-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day) (with endDate)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-15 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day) (Personalized minutely with occurrences)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day) (Personalized hourly with occurrences)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-03 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day) (Personalized yearly with occurrences)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-02-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-03-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-04-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-05-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-06-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-07-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-08-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-09-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-10-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-11-15 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-15 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayOfWeek)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-02 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayType)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-05 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-06 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with month)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-31 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with year)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-12-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-31 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day and dayType)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-04 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day and month)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-06-10 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2031-06-10 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day and year)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-10-10 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-11-10 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-10 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayOfWeek and year)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-12-16 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-23 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-30 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, dayType)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-05-20 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, month)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-07-19 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, year)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-16 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-10-16 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayType, month)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-12-16 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2031-12-16 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, month, year)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-05-16 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, dayType, month)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-09-10 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, dayType, year)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-04-05 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-07-05 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, month, year)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-05-01 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayType, month, year)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-11-30 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, dayType, month, year)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-03-01 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-02-12 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayOfWeek and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-16 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with month and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-06-30 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-03-13 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayType and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-09-07 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, month and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2033-08-28 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, year and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-12-23 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayOfWeek, dayType and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-07 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayOfWeek, month and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-09-14 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayOfWeek, year and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-21 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayType, month and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-04-14 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayType, year and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-12-31 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, dayType and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-03-17 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, month and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2047-08-16 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, year and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-12-12 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayType, year and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-04-12 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayOfWeek, dayType, month and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-10-26 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayType, month, year and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-04-07 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, dayType, month and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-11-26 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayOfWeek, dayType, year and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-10-20 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with day, dayType, month, year and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-09-09 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with a scheduling and return a Queue with the corresponding Date(s) for that scheduling. (with dayOfWeek, dayType, month, year and criteria)" in {
      ...
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-06 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
    ...
    "receive a valid TaskDTO with several schedulings and return a Queue with the corresponding Dates for those schedulings." in {
      val dto = TaskDTO("asd", "asd", SchedulingType.Personalized, Some(stringToDateFormat("2030-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), Some(PeriodType.Minutely), Some(5), Some(stringToDateFormat("2032-01-01 00:00:00", "yyyy-MM-dd HH:mm:ss")), None, None, None, None, Some(List(SchedulingDTO("asd1", "asd", None, Some(30), None, Some(DayType.Weekday), None, Some(2030)), SchedulingDTO("asd2", "asd", Some(stringToLocalDateFormat("2030-05-02", "yyyy-MM-dd"))), SchedulingDTO("asd3", "asd", None, None, Some(6), None, None, Some(2030), Some(Criteria.Third)))))
      taskService.calculateSchedulings(dto) mustBe List(stringToLocalDateFormat("2030-01-18 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-01-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-04-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-05-02 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-05-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-07-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-08-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-09-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-10-30 00:00:00", "yyyy-MM-dd HH:mm:ss"), stringToLocalDateFormat("2030-12-30 00:00:00", "yyyy-MM-dd HH:mm:ss"))
    }
  }
}